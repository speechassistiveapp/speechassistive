                ...
                children: <Widget>[
                  GestureDetector(
                    ...
                    onTap: () async {
                      ...
                      setState(() {});
                      if (data_ == "MALE") {
                        speakMaleVoice('BROWN');
                      } else if (data_ == "FEMA") {
                        speakFemaleVoice('BROWN');
                      }
                    },
                  ),
                ],
                ...
                children: <Widget>[
                  GestureDetector(
                    ...
                    onTap: () async {
                      ...
                      setState(() {});
                      if (data_ == "MALE") {
                        speakMaleVoice('GREEN');
                      } else if (data_ == "FEMA") {
                        speakFemaleVoice('GREEN');
                      }
                    },
                  ),
                ],
                ...
                children: <Widget>[
                  GestureDetector(
                    ...
                    onTap: () async {
                      ...
                      setState(() {});
                      if (data_ == "MALE") {
                        speakMaleVoice('ORANGE');
                      } else if (data_ == "FEMA") {
                        speakFemaleVoice('ORANGE');
                      }
                    },
                  ),
                ],
