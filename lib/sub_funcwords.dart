// ignore_for_file: unused_field, avoid_unnecessary_containers, prefer_interpolation_to_compose_strings, duplicate_ignore, avoid_print, unused_import, non_constant_identifier_names, unused_element, prefer_collection_literals
...
//import 'funcwrd_cook.dart';

final TextEditingController textEditingController = TextEditingController();
final FlutterTts flutterTts = FlutterTts();

// ignore: camel_case_types
class sub_Funcwords extends StatefulWidget {
  final TextEditingController textEditingController = TextEditingController();
  sub_Funcwords({super.key});
  @override

  // ignore: library_private_types_in_public_api
  _FuncwordsState createState() => _FuncwordsState();
}
...
class _FuncwordsState extends State<sub_Funcwords> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.asset('assets/videos/Sleep.mp4');
  ...
  Widget build(BuildContext context) {
    textEditingController.text = "-----Sleeping";
    return Scaffold(
      appBar: AppBar(
