// ignore_for_file: unused_field, avoid_unnecessary_containers, prefer_interpolation_to_compose_strings, duplicate_ignore, avoid_print, unused_element, prefer_collection_literals, non_constant_identifier_names, unused_import
...
class Funcwrd_Dishwash extends StatefulWidget {
  final TextEditingController textEditingController = TextEditingController();
  Funcwrd_Dishwash({super.key});
  @override

  // ignore: library_private_types_in_public_api
  _FuncwrdDishwash createState() => _FuncwrdDishwash();
}
...
class _FuncwrdDishwash extends State<Funcwrd_Dishwash> {
  ...
  void initState() {
    super.initState();
    getGuardianEmail();
    _controller = VideoPlayerController.asset('assets/videos/Dishwashing.mp4');
  ...
  Widget build(BuildContext context) {
    textEditingController.text = "-----Dishwashing";
    return Scaffold(
      appBar: AppBar(
