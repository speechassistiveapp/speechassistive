// ignore_for_file: unused_field, avoid_unnecessary_containers, prefer_interpolation_to_compose_strings, duplicate_ignore, avoid_print, unused_element, unused_import, prefer_collection_literals, non_constant_identifier_names
...
class Funcwrd_Sing extends StatefulWidget {
  final TextEditingController textEditingController = TextEditingController();
  Funcwrd_Sing({super.key});
  @override

  // ignore: library_private_types_in_public_api
  _FuncwrdSing createState() => _FuncwrdSing();
}
...
class _FuncwrdSing extends State<Funcwrd_Sing> {
  ...
  void initState() {
    super.initState();
    getGuardianEmail();
    _controller = VideoPlayerController.asset('assets/videos/Sing.mp4');
