...
class Funcwrd_Read extends StatefulWidget {
  final TextEditingController textEditingController = TextEditingController();
  Funcwrd_Read({super.key});
  @override

  // ignore: library_private_types_in_public_api
  _FuncwrdRead createState() => _FuncwrdRead();
}
...
class _FuncwrdRead extends State<Funcwrd_Read> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.asset('assets/videos/ReadingBooks.mp4');
  ...
  Widget build(BuildContext context) {
    textEditingController.text = "-----Reading";
    return Scaffold(
      appBar: AppBar(
