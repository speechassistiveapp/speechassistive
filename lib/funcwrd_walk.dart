...
class Funcwrd_Walk extends StatefulWidget {
  final TextEditingController textEditingController = TextEditingController();
  Funcwrd_Walk({super.key});
  @override

  // ignore: library_private_types_in_public_api
  _FuncwrdWalk createState() => _FuncwrdWalk();
}
...
class _FuncwrdWalk extends State<Funcwrd_Walk> {
  ...
  void initState() {
    super.initState();
    getGuardianEmail();
    _controller = VideoPlayerController.asset('assets/videos/Walk.mp4');
  ...
  Widget build(BuildContext context) {
    textEditingController.text = "-----Walking";
    return Scaffold(
      appBar: AppBar(
