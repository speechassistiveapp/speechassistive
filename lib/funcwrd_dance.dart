...
class Funcwrd_Dance extends StatefulWidget {
  final TextEditingController textEditingController = TextEditingController();
  Funcwrd_Dance({super.key});
  @override

  // ignore: library_private_types_in_public_api
  _FuncwrdDance createState() => _FuncwrdDance();
}
...
class _FuncwrdDance extends State<Funcwrd_Dance> {
  ...
  void initState() {
    ...
    _controller = VideoPlayerController.asset('assets/videos/Dance.mp4');
